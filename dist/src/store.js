...
export class MemoryStore {
    chunks = new Map();
    files = new Map(); // filePath -> Set of chunk IDs
    meta = new Map();
    dataPath;
    constructor(dataDir) {
    ...
    save() {
        const data = {
            ...
            files: Object.fromEntries(Array.from(this.files.entries()).map(([path, ids]) => [path, Array.from(ids)])),
        };
     ...
     */
    searchByVector(queryEmbedding, topK) {
