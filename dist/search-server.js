...
export class SearchServer {
    ...
    search(query, limit = 5) {
        ...
        const scored = chunks.map(chunk => {
            ...
            return {
                ...
                startLine: this.estimateLineNumber(chunk.content, chunk.charStart),
                endLine: this.estimateLineNumber(chunk.content, chunk.charEnd),
            };
        });
    ...
    health() {
        try {
            ...
            const count = this.store.getChunkCount();
