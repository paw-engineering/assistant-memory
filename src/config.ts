 ...
 */
export function resolveConfigPath(agentId: string, baseDir?: string): string {
 ...
 */
export function loadConfig(agentId: string, baseDir?: string): MemoryPluginConfig {
  const configPath = resolveConfigPath(agentId, baseDir);

  let raw: Partial<MemoryPluginConfig> = {};
 ...
 * Throws if invalid.
 */
export function validateConfig(config: MemoryPluginConfig): void {
 ...
 */
export function resolveDataDir(config: MemoryPluginConfig): string {
